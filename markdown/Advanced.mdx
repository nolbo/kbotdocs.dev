...
<Section>
    ...
    <Blockquote className="info">
        내용이 다소 미약하므로 [여기에서](https://github.com/nolbo/kbotdocs.dev/pulls) 문서의 작성을 도와주세요!
    </Blockquote>
    ...
    <Table>
        ...
        <tbody>
            <tr>
                <Td>`com.xfl.msgbot.broadcast.compile`</Td>
                <Td>`name: String`</Td>
                <Td>이름이 `name`인 `Bot` 객체를 컴파일합니다.</Td>
            </tr>
            <tr>
                <Td>`com.xfl.msgbot.broadcast.set_bot_power`</Td>
                <Td>`name: String, power: Boolean`</Td>
                <Td>이름이 `name`인 `Bot` 객체의 작동 여부를 제어합니다.</Td>
            </tr>
            <tr>
                <Td>`com.xfl.msgbot.broadcast.set_activation`</Td>
                <Td>`activation: Boolean`</Td>
                <Td>메신저봇R의 작동 여부를 제어합니다.</Td>
            </tr>
        </tbody>
    </Table>
</Section>
