...
카카오톡봇은 **카카오톡 상단바 알림을 읽고, 자동으로 응답하는 자동응답 봇**이에요. 이걸 개발하기 위해서는 [메신저봇R](https://play.google.com/store/apps/details?id=com.xfl.msgbot&hl=ko), [채팅 자동응답 봇](https://play.google.com/store/apps/details?id=com.darktornado.chatbot&hl=ko) 등의 앱이 쓰인답니다.
</section>
<section>
...
- 우선, Google Play에서 **[메신저봇R](https://play.google.com/store/apps/details?id=com.xfl.msgbot&hl=ko)** 을 설치해주세요.
