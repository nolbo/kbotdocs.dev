...
<Section>
    ...
    **플러그인**은 서드파티 개발자들이 응용 프로그램을 확장하는 기능을 만들 수 있도록 하는 일종의 확장 레이어에요. 플러그인을 이용해 기본적으로 제공하지 않는 기능들을 추가할 수 있죠.
    [여기에서](https://drive.google.com/drive/folders/12GgPeRxWrlBbj9TV2olPmeKTPfI8KW0i) 플러그인들을 다운로드할 수 있어요.
    ...
    <Section>
        ...
        **Discord**는 StarLight용 플러그인으로, 디스코드 챗봇 API의 이벤트를 수신 및 사용할 수 있게 해요.
        ...
        <Section>
            ...
            따라서 `onMessageCreate`의 매개변수인 `event`로 JavaCord의 `MessageCreateEvent` 객체가 넘겨져요.
    ...
    <Section>
        ...
        **V8**는 StarLight용 플러그인으로, Rhino JS에 V8 엔진을 이용할 수 있게 해요.
        실행 속도가 Rhino 엔진에 비해 **약 29~117배** 정도 차이가 나는게 특징이예요.
        ...
        <Section>
            ...
            `eval()` 함수의 사용 여부와 상술한 Java 클래스 수동 접근 여부를 프로젝트 설정에서 변경할 수 있어요. 사용 환경에 따라 해당 설정을 조절하여 사용하세요.
        </Section>
    </Section>
</Section>
