...
<Section>
    ...
    <AppCompatibility listTitle="Security.ariaEncodeRaw()">
        <AppCompatibilityItem msgBot={Compatibility.NO_SUPPORT} arBot={Compatibility.FULL_SUPPORT} sl={Compatibility.NO_SUPPORT}>`ariaEncodeRaw`</AppCompatibilityItem>
    </AppCompatibility>
</Section>