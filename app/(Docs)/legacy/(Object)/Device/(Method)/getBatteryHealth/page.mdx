...
export const metadata = {
    ...
    title: "Device.getBatteryHealth() - 레거시 API",
    openGraph: {
        ...openGraph,
        title: "Device.getBatteryHealth() - 레거시 API"
    }
...
<Section>
    ...
    <AppCompatibility listTitle="Device.getBatteryHealth()">
        <AppCompatibilityItem msgBot={Compatibility.FULL_SUPPORT} arBot={Compatibility.FULL_SUPPORT} sl={Compatibility.FULL_SUPPORT}>`getBatteryHealth`</AppCompatibilityItem>
    </AppCompatibility>
</Section>